    ...
    with torch.no_grad():
        if critic.discrete:
            ...
            if actor.discrete and one_hot:
                ...
                next_actions_log_probs = next_Pi.log_prob(next_actions.transpose(0, 1))  # Batch dim 2nd
                next_actions_log_probs = next_actions_log_probs.sum(-1).transpose(0, 1).flatten(1)
