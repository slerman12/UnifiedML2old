...
```offline=true``` loads data from a saved replay instead of rollouts. Rollouts, as opposed to all-in-one loading, can be useful for intractably large / dynamic datasets or curriculum learning. 
