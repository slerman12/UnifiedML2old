...
```offline=true``` loads data from a saved replay instead of rollouts. Rollouts, as opposed to all-in-one loading, may be useful for intractably large or dynamic datasets or curriculum learning. 
