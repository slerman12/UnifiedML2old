...
Then we frame actions as "predictions" in supervised learning, and treat classification datasets as environmental "suites." These yield labels, but RL can also be applied by reinforcing negative error as reward...
