...
```offline=true``` loads data from a saved replay instead of rollouts. Rollouts, rather than offline loading, can be useful for curriculum learning or dynamic/intractably large datasets. 
