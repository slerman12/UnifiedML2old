...
Then we frame actions as "predictions" in supervised learning, and this makes it easy to optimize a standard classifier or even augment learning with an RL phase. 
