...
```offline=true``` loads data from a saved replay instead of rollouts. Rollouts, rather than all-in-one loading, can be useful for dynamic/intractably large datasets or curriculum learning. 
